...
{
    public static AndConstraint<StringAssertions> BeIgnoringLineEndings(this StringAssertions stringAssertions, string expected) => stringAssertions.Subject.Should().Be(expected.NormalizeWhitespace());
